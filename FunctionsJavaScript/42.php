...
<script>
    ...
    var x4 = 2.5 ; var ε4 = 0.0001 ;
     ...
     document.getElementById('body').innerHTML = 'x is ' + x1 + ' , ε is ' + ε1 + ' and approximate value of the function cos(x) is : ' + Cos1(x1 , ε1);
    document.getElementById('body1').innerHTML = 'x is ' + x2 + ' , ε is ' + ε2 + ' and approximate value of the function cos(x) is : ' + Cos1(x2 , ε2);
    document.getElementById('body2').innerHTML = 'x is ' + x3 + ' , ε is ' + ε3 + ' and approximate value of the function cos(x) is : ' + Cos1(x3 , ε3);
    document.getElementById('body3').innerHTML = 'x is ' + x4 + ' , ε is ' + ε4 + ' and approximate value of the function cos(x) is : ' + Cos1(x4 , ε4);