...
$B2 = 2 ;
$C2 = 1 ;
echo 'before FunctionsJavaScript. call <br/>a1 =&nbsp;'.$A1.', b1 =&nbsp;'.$B1.', c1 =&nbsp;'.$C1.'<br/>';
SortInc3($A1, $B1, $C1);
echo 'after FunctionsJavaScript call <br/> a1 =&nbsp;'.$A1.', b1 =&nbsp;'.$B1.', c1 =&nbsp;'.$C1.'<br/>';
echo'<br/>';
echo 'before FunctionsJavaScript. call <br/>a1 =&nbsp;'.$A2.', b1 =&nbsp;'.$B2.', c1 =&nbsp;'.$C2.'<br/>';
SortInc3($A2, $B2, $C2);
echo 'after FunctionsJavaScript call <br/> a1 =&nbsp;'.$A2.', b1 =&nbsp;'.$B2.', c1 =&nbsp;'.$C2.'<br/>';
